...
for i in range(len(lista10)):
    összeg += int(lista10[i])
print("10", összeg)

összeg = 0

for i in range(len(lista11)):
    összeg += int(lista11[i])
print("11", összeg)

összeg = 0

for i in range(len(lista12)):
    összeg += int(lista12[i])
print("12", összeg)

összeg = 0

for i in range(len(lista13)):
    összeg += int(lista13[i])
print("13", összeg)

összeg = 0

for i in range(len(lista14)):
    összeg += int(lista14[i])
print("14", összeg)

összeg = 0

for i in range(len(lista15)):
    összeg += int(lista15[i])
print("15", összeg)

összeg = 0

for i in range(len(lista16)):
    összeg += int(lista16[i])
print("16", összeg)

összeg = 0

for i in range(len(lista17)):
    összeg += int(lista17[i])
print("17", összeg)

összeg = 0

for i in range(len(lista18)):
    összeg += int(lista18[i])
print("18", összeg)

összeg = 0

for i in range(len(lista19)):
    összeg += int(lista19[i])
print("19", összeg)

összeg = 0

for i in range(len(lista20)):
    összeg += int(lista20[i])
print("20", összeg)

összeg = 0

for i in range(len(lista21)):
    összeg += int(lista21[i])
print("21", összeg)